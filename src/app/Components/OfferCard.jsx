    ...
    <div className="menu-card offer-card">
      ...
      <div className="menu-content">
        <div className="menu-header justify-content-start">
          <h3 className="title menu-title">{product.name || "Unnamed Product"}</h3>
        </div>

        <p className="menu-desc">{product.description || "No description available."}</p>

        <div className="menu-footer">
          <span className="menu-price">
            ${product.newPrice? product.newPrice.toFixed(2) : ""}
            <span className="old-price">${product.oldPrice !== undefined ? product.oldPrice.toFixed(2) : ""}</span>
          </span>
